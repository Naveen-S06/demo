...
def motor_program(speed, load, voltage, coolant_flow):
    ...
    motor_name = motor_data_2['motor_name']
    motor_manufacturer_name = motor_data_2['motor_manufacturer_name']
    motor_mass_kg = motor_data_2['motor_masss_kg']
    motor_surface_area_m2 = motor_data_2['motor_surface_area_m2']
    motor_cp = motor_data_2['motor_cp_JpkgpK']
    motor_max_torque_Nm = motor_data_2['motor_max_torque_Nm']
    motor_max_regen_torque_Nm = motor_data_2['motor_max_regen_torque_Nm']
    motor_min_speed_rpm = motor_data_2['motor_min_speed_rpm']
    motor_max_speed_rpm = motor_data_2['motor_max_speed_rpm']
    motor_min_voltage = motor_data_2['motor_min_voltage']
    motor_max_current = motor_data_2['motor_max_current']
    motor_cost_rs = motor_data_2['motor_cost_rs']
    motor_inertia = motor_data_2['motor_inertia']
    motor_speed_map_rpm = motor_data_2['motor_speed_map_rpm']
    motor_torque_map_Nm = motor_data_2['motor_torque_map_Nm']
    motor_max_torque_map_Nm_against_speed = motor_data_2['motor_max_torque_map_Nm_against_speed']
    motor_max_regen_torque_map_Nm_against_speed = motor_data_2['motor_max_regen_torque_map_Nm_against_speed']
